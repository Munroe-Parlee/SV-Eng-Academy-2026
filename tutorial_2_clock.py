...
#######Part 1
set_time(11, 59, 55)#set time for 11hr 59min 55sec

while hh < 12:
    tick() # move time by one second
    sleep(1)

sleep(3)

set_time(1, 0, 0) # set time 1:00:00
run_clock() # runs clock forwards automatically

#manually stop the program and try changing the time
