...
rs.value(1) # select register 1 - necessary to send commands
# register 0: command input
# register 1: letter and digit input

string = '12:15 pm' #string of characters to be displayed
...
for x in string: 	# runs the indented code once per character in the string surrounded by ''
    ...
    utime.sleep_us(40)	#sleep time in micro seconds i.e. wait for 40 micro seconds between displaying characters
