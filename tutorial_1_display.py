...
#define the pause in seconds between letters
pause = 0.2

#function which will display the string with a 0.2 second pause between letters displaying
write('hello world', 0.2)

#function which will pause the program for 3 seconds
sleep(2)
...
string = 'goodbye' #this variable stores a string 
pause = 0.2 #this variable stores the delay between seconds
...
####Part 2
#alter the string and pause variables to say 'clockatoo' and 0


#####Part 3
#using the above functions (write, clear_screen, sleep), get the display to show the word alarm for one second then clear the screen and wait for 1 second

#####Part 4 - if and for statements
alarm_set = False
for x in range(5): # loop repeats 5 times
    #alarm_set is initially false, run it and you will see it displays the first phrase
    #now change alarm_set to True and run the loop again, the second should play
    if alarm_set is False:
        write("Alarm not set")
        sleep(0.5)
        clear_screen()
        sleep(0.5)
    if alarm_set is True:
        write("Alarm is set")
        sleep(0.5)
        clear_screen()
        sleep(0.5)
    ...
    pass
######Part 5 - while loops (loop while a condition is true) and incrementation
if alarm_set is False:
    write("set alarm!")
sleep(3)
loops = 0
if alarm_set is True:
    while alarm_set is True:
        ...
        loop = loop + 1 # this variable increases every loop
        
        if loop > 10: # break loop after 10 loops
            alarm_set = False
write("program over")
